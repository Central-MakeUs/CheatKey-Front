export const API_DOMAINS = {
  ...
  POST_REPORT_POST: "/v1/api/community/posts/:postId/report",
  POST_REPORT_COMMENT: "/v1/api/community/comments/:commentId/report",
  POST_BLOCK_POST: "/v1/api/community/posts/:postId/author/block",
  POST_BLOCK_COMMENT: "/v1/api/community/comments/:commentId/author/block",
