  ...
  return (
    ...
    >
      <textarea
        ...
        className="body-5-regular text-gray-system-400 placeholder:text-gray-system-600 h-full w-full resize-none border-none bg-transparent pb-6 focus:outline-none"
      />
